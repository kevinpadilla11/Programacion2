...
using namespace std;
/*
generar un arreglo que se llama base 5 numeros entre 1 y 10, igual
en el otro arreglo que se llama expo.
usar un procedimiento.
luego determinar la potencia elevando la base al expo y copiarla en otro
arreglo
*/
int const n=6;
int base [n];
...
void calcular(int base [], int expo[], long pot []; intn)
{
    int i;
    for (i=0; i<n;i++)
    {
